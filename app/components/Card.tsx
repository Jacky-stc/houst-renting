      ...
      {searchStatus === 'no result' && (
        <>
          ...
          <div className="text-center py-4 sm:text-start sm:pt-0 flex flex-col justify-evenly">
            <h1 className="font-bold text-2xl sm:text-3xl text-[#ff3838]">查無結果</h1>
            <div className="text-xs sm:text-sm pt-2 text-[#b45a50]">查詢不到符合搜尋條件的結果，請重新查詢</div>
          </div>
        </>
      )}
      {searchStatus === 'noPersonName' && (
        <>
          ...
          <div className="text-center py-4 sm:text-start sm:pt-0 flex flex-col justify-center sm:gap-10">
            <h1 className="font-bold text-2xl sm:text-3xl text-[#ff3838]">尚無業務姓名</h1>
            <div className="text-xs sm:text-sm pt-2 text-[#b45a50]">請點選上方選單選擇業務姓名</div>
          </div>
        </>
      )}
    </div>
